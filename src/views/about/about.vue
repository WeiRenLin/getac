  ...
  >
      ...
      <div id="headerContainerInner">
                ...
                <b-navbar type="dark" toggleable="md" style>
                  ...
                  <b-collapse is-nav id="nav_collapse">
                    <b-navbar-nav>
                      ...
                      <b-nav-item href="/about" :active="true">關於</b-nav-item>
        ...
        <div id="subheadcontainer">
          <div class="container">
            <div class="row">
              <div id="subheader" class="col-xs-12 col-lg-12" style>
                <div>
                  <h1 class>關於</h1>
                </div>
              </div>
              ...
              <div class="innercontentcontainer row">
                <div  class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div class="embedContent">
                    <span font-size:20px="" style=""><strong>Getac - 您的強固合作夥伴 </strong></span>
                    <br><br>
                    <p>
                      <span font-family:arial="" style="">Getac 在強固型電腦界擁有超過 25 年的豐富經驗，並持續不斷地追求產品創新與優良品質。
                        我們提供從手持設備到筆記型電腦等最完整的產品線，能為如執法機關、能源和製造業等眾多不同垂直產業的客戶提供優異運算能力，
                        讓客戶在世界上最嚴苛的條件之下也能順暢工作。Getac Technology Corporation (神基科技) 由 GE Aerospace (美國奇異航太部門) 
                        與 MiTAC (聯華神通關係企業神通電腦) 於 1989 年共同合資成立，是 MiTAC Synnex Business Group (聯華神通集團，2015 年銷貨收入達 280 億美元) 
                        旗下的策略企業。Getac 總部大樓位於台灣台北，
                        不僅設備先進，在世界各地亦派駐有業務人員及技術支援人員。</span>
                    </p>
                    
                    <br><span font-family:arial="" style="">Getac 總部 / 台灣台北</span>
                  </div>
                </div>
              </div>
            </div>
