              ...
              <div class="col-sm-`12`" id="mainNavigation">
                <b-navbar type="dark" toggleable="md" style>
                  ...
                  <b-collapse is-nav id="nav_collapse">
                    <b-navbar-nav>
                      <b-nav-item href="/registerpart1" :active="true">申請帳戶</b-nav-item>
                      <b-nav-item href="/about">關於</b-nav-item>
                      <b-nav-item-dropdown text="合作夥伴方案">
    ...
    <div id="contentcontainer" class="container">
      <div class="row">
        <section class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div>
            <div id="message"></div>
            <header id="innerContentHeader" class="innerContentHeader row"></header>
            <div class="innercontentcontainer row">
                ...
                <div id="registerdata">
                  <div class="registerdetail">
                    <input
                      ...
                      id="persondetails"
                      v-model="personDetails"
                      class=" button btn btn-primary btn btn-primary"
                      :class="{selected:selected}"
                      type="button"
                      name="personDetails"
                      @click="detailbutton($event)"
                    >
                      <input
                        id="companydetails"
                  ...
                  <div v-if="router == 'company'">
                  <registerpart2companyform ></registerpart2companyform>
                  </div>
                  <div v-else-if="router == 'user'">
                  <registerpart2userform @nextstep="nextstep"></registerpart2userform>
                  </div>
                </div>
              </div>
            </div>
...
<script>
import registerpart2userform from "./registerpart2userform";
import registerpart2companyform from "./registerpart2companyform";

export default {
  components: {
    registerpart2userform,registerpart2companyform
  },
  data(){
    return{
   personDetails:"您的詳細資料",
   companyDetails:"公司詳細資料",
   router:"",
   disabled:0,
   selected:true,
    }
  ...
  methods:{
    detailbutton(val){
      var vm = this;
      if(val.target.value == "公司詳細資料")
      {
        vm.router = "company"
        vm.disabled = 1;
        vm.selected = false;
        // this.$router.push({name:'registerpart2companyform'})
      }
      else if(val.target.value == "您的詳細資料")
      {
        vm.router = "user"
         vm.selected = true;
      }
